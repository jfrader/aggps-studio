...
Descargue `aggps-studio-0.4.3-*.zip` (artefactos de CI o release). Extraiga la carpeta onedir.
...
El lanzador usa el backend GTK nativo del escritorio y funciona con Wayland y X11.
