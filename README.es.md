...
Descargue `aggps-studio-0.4.2-*.zip` (artefactos de CI o release). Extraiga la carpeta onedir.
...
El lanzador usa el backend X11 de GTK. Los escritorios Wayland requieren XWayland.
