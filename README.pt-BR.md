...
Baixe `aggps-studio-0.4.2-*.zip` (artefatos de CI ou release). Extraia a pasta onedir.
...
O inicializador usa o backend X11 do GTK. Ambientes Wayland precisam do XWayland.
